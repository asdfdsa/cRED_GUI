...
class ImgConversion:
    ...
    flatfield=fabio.open('flatfield_tpx_2017-06-21.tiff')
    data=flatfield.data
    ...
    def __init__(self,flatfield,pxd):
        self.flatfield=flatfield
        self.pxd=pxd
        
    def TiffToIMG(self,pathtiff,pathsmv,cl,startangle,osangle,logger):
        import collections
    ...
    def XDSINPCreator(self,pathsmv,indend,startangle,lowres,highres,pb,cl,osangle,RA,logger):
